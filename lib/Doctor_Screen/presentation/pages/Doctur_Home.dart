...
import 'package:project/Doctor_List/presentation/widgets/calling.dart';
import 'package:project/Doctor_Screen/presentation/widgets/List.dart';
import 'package:project/Doctor_Screen/presentation/widgets/cart.dart';
import 'package:project/theme/colors.dart';

class DocturHome extends StatelessWidget {
  final Doctor doctor;

  const DocturHome({super.key, required this.doctor});
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Call_Doctor_List()),
                );
              },
            ),
            ListTile(
              ...
              child: ListView(
                children:  [
                  ...
                  AppointmentTile(
                    time: '10:15 AM',
                    patientName: 'Patient Name',
                    status: 'completed', doctor: doctor,
                  ),
                  AppointmentTile(
                    time: '10:30 AM',
                    patientName: 'Patient Name',
